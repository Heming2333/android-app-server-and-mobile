	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btn_send.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
				...
				intent.setClassName(RegisterActivity.this,"com.example.myprodWeb.DisplayActivity");
	...
	private class ButtonListener implements OnClickListener {
		public void onClick(View v) {
			...
			case R.id.btn_save:
				...
				try {
					fos = openFileOutput("data"+et_name.getText().toString().trim()+".txt", Context.MODE_APPEND);
			...
			case R.id.btn_read:
				String content = "";
				try {
					FileInputStream fis = openFileInput("data"+et_name.getText().toString().trim()+".txt");
