...
public class MainActivity extends Activity {
    ...
    {   
    	...
    	starSearchBtn=(Button)findViewById(R.id.btnStarSearch);
    	backupPersonBtn=(Button)findViewById(R.id.btnBackupPerson);
    }
    void setListeners()
    {
    	...
    	starSearchBtn.setOnClickListener(new OnClickListener(){
    		@Override 
    		public void onClick(View v){
    			Intent intent=new Intent();
    			intent.setClassName(MainActivity.this,"com.example.myprodWeb.StarSearchActivity");
    			startActivity(intent);
    		}
    		
    	}
    	);
    	backupPersonBtn.setOnClickListener(new OnClickListener(){
    		@Override 
    		public void onClick(View v){
    			Intent intent=new Intent();
    			intent.setClassName(MainActivity.this,"com.example.myprodWeb.BackupPersonActivity");
    			startActivity(intent);
    		}
